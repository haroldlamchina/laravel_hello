...
@section("content")
        <div class="col-sm-8">
            <blockquote>
                ...
                @include("user.baged.like",['target_user'=>$user])
            </blockquote>
        </div>
                ...
                <div class="tab-content">
                        ...
                        <div class="blog-post" style="margin-top: 30px">
                            <p class=""><a href="/user/{{$post->user->id}}">{{$post->user->name}}</a>
                                @if($post->created_at->diffInDays()!=0)
                                    {{$post->created_at->diffInDays()}}天前
                                @else
                                    {{$post->created_at->diffInHours()}}小时前
                                @endif</p>
                    ...
                    <div class="tab-pane" id="tab_2">
                        ...
                        <div class="blog-post" style="margin-top: 30px">
                            ...
                            @include("user.baged.like",['target_user'=>$suser])
                    ...
                    <div class="tab-pane" id="tab_3">
                        ...
                        <div class="blog-post" style="margin-top: 30px">
                            ...
                            @include("user.baged.like",['target_user'=>$fuser])
